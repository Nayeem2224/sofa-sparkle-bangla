  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">সকল বুকিং দেখুন ও ম্যানেজ করুন</p>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="relative flex-1">
          ...
          <Input
            placeholder="নাম, ফোন বা বুকিং নম্বর দিয়ে খুঁজুন..."
            value={search}
      ...
      <Dialog open={!!selectedBooking} onOpenChange={(o) => !o && setSelectedBooking(null)}>
        <DialogContent className="max-w-lg rounded-2xl">
          <DialogHeader>
            <DialogTitle className="font-[Poppins]">বুকিং বিবরণ</DialogTitle>
          </DialogHeader>
          {selectedBooking && (
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-3 text-sm">
                ...
                <div>
                  ...
                  <p className="font-semibold">
                    {selectedBooking.preferred_date} — {(selectedBooking as any).available_time_slots?.slot_label}
                  </p>
                </div>
              ...
              <div className="space-y-2">
                ...
                <Button
                  size="sm"
                  onClick={() => {
                    updateStatus.mutate({ id: selectedBooking.id, status: selectedBooking.status, note: adminNote });
                  }}
