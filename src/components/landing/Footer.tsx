      ...
      <div className="container py-10 sm:py-14 px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-10">
          ...
          <div className="space-y-4">
            <h3 className="text-lg sm:text-xl font-extrabold font-poppins tracking-tight text-white">
        ...
        <div className="border-t border-white/10 mt-8 sm:mt-10 pt-6">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-2 text-sm text-white/50 text-center">
            <span>© {new Date().getFullYear()} Purexify সর্বস্বত্ব সংরক্ষিত</span>
            <span className="hidden sm:inline">|</span>
            <span className="inline-flex items-center gap-1">
              Designed &amp; Marketing By{" "}
              <a
